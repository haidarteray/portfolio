...
--
-- Hôte : localhost
-- Généré le : mar. 03 fév. 2026 à 10:45
...
CREATE TABLE `blesse` (
  ...
  `date_blessure` varchar(50) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `affecte`
  ...
  ADD KEY `affecte_code_unite_FK` (`code_unite`);
...
ALTER TABLE `affecte`
  ...
  ADD CONSTRAINT `affecte_code_unite_FK` FOREIGN KEY (`code_unite`) REFERENCES `unites` (`code_unite`);
